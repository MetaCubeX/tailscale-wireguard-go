...
//
//	"(*github.com/metacubex/tailscale-wireguard-go/device.Device).SetPrivateKey" → "(*Device).SetPrivateKey"
//	"(github.com/metacubex/tailscale-wireguard-go/device.Peer).Foo"              → "(Peer).Foo"
//	"github.com/metacubex/tailscale-wireguard-go/device.SomeFunc"                → "SomeFunc"
